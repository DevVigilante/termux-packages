...
##
TERMUX__NAME="com.logicodeum.ide"
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# Default value: `com.logicodeum.ide`
##
TERMUX_APP__PACKAGE_NAME="com.logicodeum.ide"
...
#
# Default value: `/data/data/com.logicodeum.ide`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/termux`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/termux/core`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/termux/app`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/termux/app/i`
##
...
# `TERMUX__APPS_DIR`.
#
# Default value: `/data/data/com.logicodeum.ide/termux/app/u`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/home`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/home/.termux`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/glibc`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/bin`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/etc`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/include`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/include32`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/include` (`$TERMUX__PREFIX__BASE_INCLUDE_DIR`)
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/lib`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/lib32`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/lib` (`$TERMUX__PREFIX__BASE_LIB_DIR`)
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/libexec`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/opt`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/share`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/var`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/tmp`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/etc/profile.d`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/etc/termux`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/cache`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/etc/termux/termux-bootstrap`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/files/usr/etc/termux/termux-bootstrap/second-stage`
##
...
##
# Termux environment variables com.logicodeum.ide:API sub scope.
#
# **Do not modify this!** This is considered a constant com.logicodeum.ide:API
...
##
# Termux environment variables com.logicodeum.ide:API scope.
#
# **Do not modify this!**
#
...
##
# Termux environment variables com.logicodeum.ide:API app sub scope.
#
...
##
# Termux environment variables com.logicodeum.ide:API app scope.
#
# **Do not modify this!**
#
...
# Default value: `com.logicodeum.ide`
##
TERMUX_APP__NAMESPACE="com.logicodeum.ide"
...
#
# Default value: `/data/data/com.logicodeum.ide/termux/app/i/termux`
##
...
#
# Default value: `com.logicodeum.ide.app.TermuxActivity`
##
...
#
# Default value: `com.logicodeum.ide.app.TermuxService`
##
...
#
# Default value: `com.logicodeum.ide.app.RunCommandService`
##
...
#
# Default value: `com.logicodeum.ide.app.TermuxOpenReceiver`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/termux/app/i/termux/termux-apps-info.env`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/termux/app/i/termux/termux-apps-info.json`
##
...
#
# Default value: `/data/data/com.logicodeum.ide/termux/app/i/termux/termux-am`
##
...
####
# Variables for the com.logicodeum.ide:API app that hosts the packages.
#
# - https://github.com/termux/termux-api
####

##
# com.logicodeum.ide:API app package name used for
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# Default value: `com.logicodeum.ide.api`
##
TERMUX_API_APP__PACKAGE_NAME="com.logicodeum.ide.api"
...
##
# com.logicodeum.ide:API app name.
#
# Default value: `com.logicodeum.ide:API`
##
...
##
# com.logicodeum.ide:API app identifier for `TERMUX__APPS_DIR_BY_IDENTIFIER` subdirectory.
#
...
##
# com.logicodeum.ide:API app repo name.
#
...
##
# com.logicodeum.ide:API app repo url.
#
...
##
# com.logicodeum.ide:API app namespace, i.e the Java package name under which
# com.logicodeum.ide:API classes exists used for `TERMUX_API_APP__*_CLASS__*` and
# `TERMUX_API_APP__*_(ACTIVITY|RECEIVER|SERVICE)__*` variables.
#
# **See Also:**
# - `TERMUX_API_APP__PACKAGE_NAME`.
...
# Default value: `com.logicodeum.ide.api`
##
TERMUX_API_APP__NAMESPACE="com.logicodeum.ide.api"
...
##
# com.logicodeum.ide:API app apps directory path under `TERMUX__APPS_DIR_BY_IDENTIFIER`.
#
# Default value: `/data/data/com.logicodeum.ide/termux/app/i/termuxapi`
##
...
##
# com.logicodeum.ide:API app Android API `BroadcastReceiver` class name that
...
#
# Default value: `com.logicodeum.ide.api.TermuxApiReceiver`
##
...
#
# Constant value: `com.logicodeum.ide.termuxam`
##
TERMUX_AM_APP__NAMESPACE="com.logicodeum.ide.termuxam"
...
#
# Default value: `com.logicodeum.ide.termuxam.Am`
##
...
TERMUX_REPO_APP__PACKAGE_NAME="com.logicodeum.ide"
TERMUX_REPO_APP__DATA_DIR="/data/data/com.logicodeum.ide"
TERMUX_REPO__CORE_DIR="/data/data/com.logicodeum.ide/termux/core"
TERMUX_REPO__APPS_DIR="/data/data/com.logicodeum.ide/termux/app"
TERMUX_REPO__ROOTFS="/data/data/com.logicodeum.ide/files"
TERMUX_REPO__HOME="/data/data/com.logicodeum.ide/files/home"
TERMUX_REPO__PREFIX="/data/data/com.logicodeum.ide/files/usr"
