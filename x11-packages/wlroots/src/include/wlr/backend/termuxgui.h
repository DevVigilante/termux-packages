...
/**
 * Creates a com.logicodeum.ide:GUI backend, and connection to the com.logicodeum.ide:GUI plugin.
 * A com.logicodeum.ide:GUI backend has no outputs or inputs by default.
 */
struct wlr_backend *wlr_tgui_backend_create(struct wl_event_loop *loop);
/**
 * Create a new com.logicodeum.ide:GUI output.
 *
 * Will use com.logicodeum.ide:GUI plugin to create Activity and SurfaceView, the buffers presented
